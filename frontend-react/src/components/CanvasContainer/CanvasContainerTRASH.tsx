...
interface CanvasContainerProps {
  node: { id: number };
  splitNode: (node: { id: number }, direction: 'horizontal' | 'vertical') => void;
  selectedTimestamp: number | null; // Add the selectedTimestamp prop
  topics: string[]; // Add the topics prop
}
