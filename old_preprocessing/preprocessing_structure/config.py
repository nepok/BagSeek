...
class Config:
    ...
    def __init__(self):
        ...
        self.representative_previews_dir = Path(os.getenv("BASE") + os.getenv("REPRESENTATIVE_PREVIEWS"))
        ...
        self.grid_size = float(os.getenv("GRID_SIZE", "10.0"))
    ...
    def __repr__(self) -> str:
        ...
        return (
            ...
            f"\n"
            f"  # Frontend Output\n"
            f"  representative_previews_dir={self.representative_previews_dir},\n"
